...
json_file_path = "/home/khf/liutao/Baselines/ImageReward/data/prompts/simple_prompts_10.json"
...
def chat_loop(
    ...
    def generate_require_outputs(inp):
    ...
    for entry in json_data:
        ...
        outputs = generate_require_outputs(inp)
        print("outputs: ", outputs)
        entry['complex'] = outputs
    
    # 保存更新后的 JSON 数据
    save_json_path = "/home/khf/liutao/Baselines/ImageReward/data/prompts/prompts_s2c_10.json"
